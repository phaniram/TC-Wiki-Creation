Creating Mararathon Match Using Admin Tool
================
...
9. On `Round Segments` window: 
 ...
 5. Click `OK` button.
  ![alt text](https://github.com/macs054/TC-Wiki-Creation/blob/master/img-wiki/marathon-admintool/admin_round_click_segment.PNG "Admin Round Segments window")
